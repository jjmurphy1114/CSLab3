...
(check-expect (find-widgets-cheaper-than--widget Wire 10) (list Wire))
(check-expect (find-widgets-cheaper-than--widget Cord 10) (list Cord Wire))
(check-expect (find-widgets-cheaper-than--widget Cord 1) empty)
(check-expect (find-widgets-cheaper-than--low (widget-parts Telephone) 8)
              (list Receiver Buttons Numbers Cord Wire))
(check-expect (find-widgets-cheaper-than--low (widget-parts Telephone) 6)
